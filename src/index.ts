...
export { QVariantMap } from './lib/QtCore/QVariantMap';
export { QJsonObject } from './lib/QtCore/QJsonObject';
export { QJsonValue } from './lib/QtCore/QJsonValue';
...
export { QWebData } from "./lib/QtWebEngine/QWebData";
