...
Napi::Object Main(Napi::Env env, Napi::Object exports) {
  ...
  QVariantMapWrap::init(env, exports);
  QJsonObjectWrap::init(env, exports);
  QJsonValueWrap::init(env, exports);
  ...
  QShowEventWrap::init(env, exports);
